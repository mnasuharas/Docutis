...
- Obtain dermatologist sign-off on the melanoma in situ statement, the absence of a German S3 structured interval, and the use of `not specified` for all four modalities.
